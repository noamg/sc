function [startTime]=visa_yoni_manThermalAutoMeas_5(heatCurr,coilCurrent, is_external, startTime)
...
try
    ...
    if is_external
        ...
        fnamePattern='THI_manThrmAutoMeas_5_external';
    else
        sampleCurrent_no_zeros=linspace(0, 3, 15);
        fnamePattern='THI_manThrmAutoMeas_5_internal';
    end

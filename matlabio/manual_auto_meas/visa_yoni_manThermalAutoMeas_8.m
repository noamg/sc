function [startTime]=visa_yoni_manThermalAutoMeas_8(heatCurr,coilCurrent)
...
%         sampleCurrent_no_zeros=linspace(0, 3, 15);
        sampleCurrent_no_zeros=linspace(0, 0.2, 30);
        fnamePattern='THI_manThrmAutoMeas_8_internal';
    end

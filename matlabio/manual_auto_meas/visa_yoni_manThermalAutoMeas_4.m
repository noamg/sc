function [startTime]=visa_yoni_manThermalAutoMeas_3(heatCurr,coilCurrent,startTime)
...
try
    ...
    %scSmallDelta = 0.1;
    %scN = 3;
    sampleCurrent_no_zeros=linspace(0, 0.3, 10);
    ...
    fnamePattern='THI_manThrmAutoMeas_4';
